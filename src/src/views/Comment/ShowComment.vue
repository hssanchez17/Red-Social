  		...
  		<div class="row row justify-content-md-center">
              ...
              <li class="list-group-item">
                <div class="row">
                  ...
                  <blockquote class="col" v-if="!permissionToUpdate">
                    <p class="lead">{{comment.comment}}</p>
                    <footer class="blockquote-footer">{{email}}</footer>
                  </blockquote>

                  <div class="col" v-if="permissionToUpdate">
                    <textarea placeholder="Descripcion de su comentario" v-model="commentEdited.comment"></textarea> 
                  ...
                  <div v-if="commentOwner">
                   ...
                   <button class="btn btn-danger" id="btn-toggle-comment">  Delete</button>
                  </div>
